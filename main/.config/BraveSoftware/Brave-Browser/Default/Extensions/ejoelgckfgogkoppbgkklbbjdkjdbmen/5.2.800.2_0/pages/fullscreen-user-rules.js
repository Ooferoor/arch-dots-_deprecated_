...
const renderSavingState = (savingRulesState)=>{
    const indicatorTextMap = {
        [savingFSM/* SavingFSMState */.A3.Idle]: null,
        [savingFSM/* SavingFSMState */.A3.Saved]: translator/* translator */.N.getMessage('options_editor_indicator_saved'),
        [savingFSM/* SavingFSMState */.A3.Saving]: translator/* translator */.N.getMessage('options_editor_indicator_saving')
    };
    ...
    const indicatorClassnames = classnames_default()('editor__label', {
        'editor__label--saved': savingRulesState === savingFSM/* SavingFSMState */.A3.Saved
    });
...
const SavingButton = ({ onClick, savingState, contentChanged })=>{
    ...
    },  true && renderSavingState(savingState), /*#__PURE__*/ react.createElement("button", {
        type: "button",
        className: "button button--l button--green-bg actions__btn actions__btn--saving",
        onClick: onClick,
        title: translator/* translator */.N.getMessage('options_editor_save'),
        disabled: !contentChanged,
        "aria-keyshortcuts": user_agent/* UserAgent */.B.isMacOs ? 'Meta+S' : 'Ctrl+S'
    }, translator/* translator */.N.getMessage('options_editor_save')));
};
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(67361);
...
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32836);
/* harmony import */ var _common_common_filter_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2881);
/**
 * Copyright (c) 2015-2025 Adguard Software Ltd.
 *
 * @file
 ...
 */ const sortFilters = (filters)=>{
    ...
    .filter((filter)=>{
        ...
        return _common_common_filter_utils__WEBPACK_IMPORTED_MODULE_1__/* .CommonFilterUtils */ .r.isRegularFilterMetadata(filter) ? !filter.deprecated : true;
    });
    return sorted;
};
/**
...
const sortGroupsOnSearch = (groups)=>{
    const sortedGroups = (0,lodash_es__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(groups, 'displayNumber').sort((a, b)=>{
        // enabled first
...
var helpers = __webpack_require__(32081);
